...
startbbr(){
	...
	wget --no-check-certificate -O ./tcp_tsunami.c https://raw.githubusercontent.com/smallwhiter/vps.github.io/master/Other/tcp_tsunami.c
	...
	wget -O /etc/sysctl.conf -N --no-check-certificate https://raw.githubusercontent.com/smallwhiter/vps.github.io/master/Other/sysctl.conf
	sysctl -p
